...
wordDoc = docx.Document("/Users/tingting/数学英语词汇.docx")
...
wb = openpyxl.load_workbook("/Users/tingting/重点单词.xlsx")
...
# 生成一个从1开始的索引index
for idx,value in enumerate(correctList,1):
    
    # TODO 使用if语句判断B列数据与正确答案不一致时
    if sheet[f"B{idx}"].value != value:
        # TODO 若不一致，则将正确的中文意思添加到第C列中
        sheet[f"C{idx}"].value = value

# TODO 使用save()函数将单词表保存到指定路径 /Users/tingting/重点单词.xlsx
wb.save("/Users/tingting/重点单词.xlsx")
